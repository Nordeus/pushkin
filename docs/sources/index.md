...
We also presume that you have implemented GCM client side. For instructions you can look [here](https://developers.google.com/cloud-messaging/android/client).
...
You can ask questions and join the development discussion on the [Pushkin-Dev Google group](https://groups.google.com/a/nordeus.eu/forum/#!forum/pushkin.dev).
